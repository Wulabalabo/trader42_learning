...
Trader42 指标字典 是一个面向新手交易员和想补基础的人准备的指标字典。当前已经上线美国和欧元区两个 market 学习入口，优先覆盖美国宏观数据，并开始搭建多市场学习框架；后续会继续扩展到中国、日本和 Crypto。
...
- 市场教学页：美国、欧元区已上线四主题结构；中国、日本、Crypto 当前为占位页
...
- `美国市场`：已上线 market 首页，以及通胀、就业、政策、增长四个主题页
- `欧元区市场`：已上线 market 首页，以及通胀、政策、增长、就业四个主题页
- `中国市场`：已上线 market 首页，以及增长与内需、地产与信用脉冲、政策托底与汇率、商品需求与区域传导四个主题页
- `日本市场`：当前为占位页
- `Crypto 市场`：当前为占位页

## 当前指标覆盖

- 美国：CPI、PCE、非农就业人数、FOMC 利率决议、ISM PMI，以及失业率、失业金、JOLTS、Core CPI、Core PCE、PPI、Retail Sales、密歇根消费者信心等
- 欧元区：HICP、核心 HICP、ECB 存款便利利率、欧元区商业景气指数、欧元区失业率
...
欧元区市场当前已经具备主题页和单指标学习框架，但数据层仍以学习样本为主：HICP、核心 HICP、ECB 存款便利利率、欧元区失业率先使用样本路径，欧元区商业景气指数会优先接 TradingEconomics 公共页的最新值。
